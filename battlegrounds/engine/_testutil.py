...
def create_drawer():
    ...
    class Drawer(object):
        ...
        def draw_segment(self, segment):
            bg1, fg1 = draw_circle(segment.origin.x, segment.origin.y, 0.15, 8,
                                   color=(0.5, 0.5, 0.5))
            bg2, fg2 = draw_circle(segment.pivot.x, segment.pivot.y, 0.15, 8,
                                   color=(0.5, 0.5, 0.5))
            line = (
                gl.GL_LINES,
                ("v2f", (segment.origin.x, segment.origin.y,
                         segment.pivot.x, segment.pivot.y)),
            )
            return [bg1, bg2], [fg1, fg2, line]
